...
use ParamConverter\Converter\DoctrineConverter;
use ParamConverter\Annotation\ParamConverter;
use Doctrine\Common\Persistence\ManagerRegistry;

class DoctrineConverterTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ManagerRegistry
     */
