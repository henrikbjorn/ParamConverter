...
use ParamConverter\Converter\ConverterInterface;
...
class ConverterManager
{
    ...
    *
    * @param ConverterInterface $converter A ConverterInterface instance
    * @param int                     $priority  The priority (between -10 and 10).
    * @param string                  $name      Name of the converter.
    */
    public function add(ConverterInterface $converter, $priority = 0, $name = null)
    {
        if ($priority !== null) {
